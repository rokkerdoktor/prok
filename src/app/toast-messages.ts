export const MESSAGES = {
    ...
    COMMENT_ADD_SUCCESS: 'Hozzászólás sikeresen hozzáadva.',
    COMMENT_REMOVE_SUCCESS: 'Hozzászólásodat töröltük!',
    COMMENT_UPDATE_SUCCESS: 'Hozzászólás sikeresen frissítettük.',
